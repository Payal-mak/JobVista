...
<body>
    <!-- Navigation -->
    <nav class="navbar navbar-expand-lg navbar-dark shadow-sm" style="background-color: #29366f;">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="index.php">
                <img src="assets/images/logo.png" alt="Logo" height="20" width="auto" class="me-2">
                <span style="font-weight: 600;"><?= defined('SITE_NAME') ? SITE_NAME : 'JobVista' ?></span>
            </a>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item ms-2">
                            <a class="btn btn-primary" href="register.php" style="background-color: #1491ea; border-color: #1491ea;"><i class="fas fa-user-plus me-1"></i> Register</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
    ...
    <main class="pb-5">
        <?php if (isset($_SESSION['message'])): ?>
            <div class="alert alert-<?= $_SESSION['message_type'] ?? 'info' ?> alert-dismissible fade show mb-0" role="alert">
